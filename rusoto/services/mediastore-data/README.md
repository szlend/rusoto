...
# Rusoto MediaStoreData
Rust SDK for AWS Elemental MediaStore Data Plane
...
To use `rusoto_mediastore_data` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
rusoto_mediastore_data = "0.35.0"
```
